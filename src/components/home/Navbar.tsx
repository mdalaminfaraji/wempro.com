      ...
      <div className="bg-green-600 text-white py-2 px-4">
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-4">
            <a href="tel:925-238-1915" className="flex items-center space-x-2 hover:text-gray-200">
              <FaPhone className="text-sm" />
              <span className="text-sm">925-238-1915</span>
            </a>
            <a href="mailto:contact@wempro.com" className="flex items-center space-x-2 hover:text-gray-200">
